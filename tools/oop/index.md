...
Сухим академическим языком _[проектирование](/tools/architecture-and-design-patterns/)_ — это «определение внутренних свойств системы и детализация её внешних (видимых) данных» 🤨
...
Для создания подобных диаграмм используются разные инструменты, но чаще всего — [UML (Unified Modeling Language)](https://ru.wikipedia.org/wiki/UML).
